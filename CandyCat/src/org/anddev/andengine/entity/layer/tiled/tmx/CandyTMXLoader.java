...
public class CandyTMXLoader extends TMXLoader {
	...
	public CandyTMXLoader(final String theme, final Context pContext,
		...
		super(pContext, pTextureManager, pTextureOptions,
				pTMXTilePropertyListener);
		beginning = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><map version=\"1.0\" orientation=\"orthogonal\" width=\"24\" height=\"18\" tilewidth=\"64\" tileheight=\"64\"><tileset name=\"Background\" tilewidth=\"64\" tileheight=\"64\" spacing=\"3\" margin=\"2\"><image source=\"gfx/"
				+ theme
	...
	public TMXTiledMap load(final InputStream pInputStream)
		...
		try {
			...
			final TMXParser tmxParser = new TMXParser(this.mContext,
					this.mTextureManager, this.mTextureOptions,
					this.mTMXTilePropertyListener);
			xr.setContentHandler(tmxParser);

			final List<InputStream> streams = Arrays.asList(
					new ByteArrayInputStream(beginning.getBytes()),
					pInputStream, new ByteArrayInputStream(end.getBytes()));

			xr.parse(new InputSource(new BufferedInputStream(
