...
/* ******** O R D E R E D B A S E 6 4 A L P H A B E T ******** */
   ...
   */
  private final static byte[] _ORDERED_DECODABET = {-9, -9, -9, -9, -9, -9, -9, -9, -9, // Decimal 0
// - 8
      -5, -5, // Whitespace: Tab and Linefeed
      -9, -9, // Decimal 11 - 12
      -5, // Whitespace: Carriage Return
...
/* ******** E N C O D I N G M E T H O D S ******** */
  ...
  public static byte[] encodeBytesToBytes(byte[] source, int off, int len, int options)
    ...
    if (source == null) { throw new NullPointerException("Cannot serialize a null array."); } // end
// if: null

    if (off < 0) { throw new IllegalArgumentException("Cannot have negative offset: " + off); } // end
// if: off < 0

    if (len < 0) { throw new IllegalArgumentException("Cannot have length offset: " + len); } // end
// if: len < 0
...
/* ******** D E C O D I N G M E T H O D S ******** */
  ...
  private static int decode4to3(byte[] source, int srcOffset, byte[] destination, int destOffset,
    ...
    if (destination == null) { throw new NullPointerException("Destination array was null."); } // end
// if
...
// }
  ...
  public static byte[] decode(byte[] source, int off, int len, int options)
    ...
    // Lots of error checking and exception throwing
    if (source == null) { throw new NullPointerException("Cannot decode null source array."); } // end
// if
    ...
    if (len == 0) {
      return new byte[0];
        ...
        "Base64-encoded string must have at least four characters, but length specified was " + len); } // end
// if
    ...
    for (i = off; i < off + len; i++) { // Loop through source
      ...
      if (sbiDecode >= WHITE_SPACE_ENC) {
        ...
        throw new java.io.IOException(String.format(
            "Bad Base64 input character decimal %d in array position %d", ((int) source[i]) & 0xFF,
            i));
      } // end else:
  ...
  public static void encodeToFile(byte[] dataToEncode, String filename) throws java.io.IOException {
    ...
    if (dataToEncode == null) { throw new NullPointerException("Data to encode was null."); } // end
// iff
  ...
  public static byte[] decodeFromFile(String filename) throws java.io.IOException {
    ...
    try {
      ...
      if (file.length() > Integer.MAX_VALUE) { throw new java.io.IOException(
          "File is too big for this convenience method (" + file.length() + " bytes)."); } // end
// if: file too big for int index
...
// math on small files (v2.2.1); Need +1 for a few corner cases (v2.3.5)
      int length = 0;
      int numBytes = 0;
