...
public class AltSSLSocketFactory implements LayeredSocketFactory {
     ...
     */
    private static final AltSSLSocketFactory DEFAULT_FACTORY = new AltSSLSocketFactory();
     ...
     */
    public static AltSSLSocketFactory getSocketFactory() {
    ...
    public AltSSLSocketFactory(final KeyStore keystore, final String keystorePassword) 
            throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException
    {
        this(TLS, keystore, keystorePassword, null, null, null);
    }

    public AltSSLSocketFactory(final KeyStore truststore) 
            throws NoSuchAlgorithmException, KeyManagementException, KeyStoreException, UnrecoverableKeyException
    {
    ...
    public AltSSLSocketFactory(final SSLContext sslContext)
    {
