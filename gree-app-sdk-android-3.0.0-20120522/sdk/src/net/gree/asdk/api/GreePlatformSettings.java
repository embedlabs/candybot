 ...
 * @param is_enable true is enable to show notification
 */
  public static final void setNotificationEnabled(boolean is_enable) {
    String value = "false";
    if (is_enable == true) {
      value = "true";
    }
 ...
 * @param is_enable true is enable to show local notification
 */
 ...
 * @param is_enable true is enable to show local notification
 */
  public static final void setLocalNotificationEnabled(boolean is_enable) {
    String value = "true";
    if (is_enable == true) {
      value = "false";
    }
   ...
   * @param is_bottom  the flag of whether the place of notification balloon is at bottom.
   */
  public static final void setNotificationsAtScreenBottom(boolean is_bottom) {
    String value = "false";
    if (is_bottom == true) {
      value = "true";
    }
