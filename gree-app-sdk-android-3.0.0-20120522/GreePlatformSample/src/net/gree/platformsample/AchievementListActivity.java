...
public class AchievementListActivity extends BaseActivity implements AchievementListUpdateListener {
  ...
  private void updateProfileNumber() {
    totalScore = 0;
    totalNumAchievement = 0;
    totalMyScore = 0;
    totalUnlockedNumAchievement = 0;
    for (Achievement one : data) {
      totalScore += one.getScore();
      totalNumAchievement++;
      if (one.isUnlocked()) {
        totalMyScore += one.getScore();
        totalUnlockedNumAchievement++;
      }
    }
  }
  ...
  protected void showProfileFirstLine() {
    String firstLineText =
        "Unlocked:" + totalUnlockedNumAchievement + " Loaded:" + totalNumAchievement;
  ...
  protected void showProfileSecondLine() {
    String secondText = "Score : " + totalMyScore + "/" + totalScore;
